                                    ...
                                    <form action="UploadExternalsCSV.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-8">
                                                <h5>
                                                    Have a CSV file?
                                                    <a href="https://raw.githubusercontent.com/Thirumalai-Shaktivel/Student-Management-System/master/resource/ExternalsExample.csv"> upload format </a>
                                                </h5>
                                ...
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-lg-5">
                                                <a href="Exam.php" role="button" class="btn btn-outline-warning btn-lg btn-block">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
